const projectsList = [
  ...
  },
  {
    ...
    githubLink: 'https://github.com/otrocadev/javascript-100',
    liveLink: 'https://javascript100.otroca.dev/',
    imageUrl: 'javascript100.avif',
    description:
  ...
  {
    title: 'Tesla Landing Clone Page',
    githubLink: 'https://github.com/otrocadev/tesla-landing-clone',
    liveLink: 'https://tesla-landing.otroca.dev/',
    imageUrl: 'tesla-landing.avif',
    description:
      'A clone that replicates the frontend of the Tesla.es website in orther to put in practice my Astro and Tailwind knowledge',
